      ...
      <main className="flex-1 flex flex-col relative">
        <header className="p-4 flex items-center justify-between z-[100] bg-[#020205]/80 backdrop-blur-md sticky top-0">
          ...
          <div className="flex items-center gap-6 pr-12">
            <button className="text-[15px] font-bold capitalize text-zinc-400 hover:text-[#6366f1] transition-colors">Install</button>
            <button className="text-[15px] font-bold capitalize  text-zinc-400 hover:text-[#6366f1] transition-colors">Log In</button>
