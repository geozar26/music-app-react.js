      ...
      <main className="flex-1 flex flex-col relative">
        <header className="p-4 flex items-center justify-between z-[100] bg-[#020205]/80 backdrop-blur-md sticky top-0">
          ...
          <div className="flex items-center gap-6 pr-12">
            <button className="text-[5px] font-bold uppercase text-zinc-400 hover:text-white transition-colors">Install</button>
            <button className="text-[5px] font-bold uppercase text-zinc-400 hover:text-white transition-colors">Log In</button>
